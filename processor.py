...
model_files = {
    '045': 'finalized_xgb_model.json',
    '179': 'astoria_xgb_model.json',
    '162': 'clatsop_xgb_model.json',
    '264': 'finalized_xgb_model.json',
    '271': 'finalized_xgb_model.json'
...
for stn in buoys:
    ...
    if waveHs_f is None or waveTa_f is None or time_array_f is None:
        print(f"Skipping forecast for buoy {stn}.")
        continue
